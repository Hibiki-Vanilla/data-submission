<template>
  <div class="actRow">
    <el-form ref="queryForm" :model="query" :inline="true">
      <div class="leftBox">
        <!-- <el-form-item label="提交用户" prop="creatorId">
          <el-input
      ...
      <el-form-item>
        <div class="rightItem">
          <el-button
            type="primary"
            v-show="$inAuthority('1761990651508580385', 0)"
    ...
    >
          ...
          <el-row>
            ...
            >
              <el-option
                ...
                :key="conditionIndex"
                :label="conditionList[conditionItem].label"
                :value="conditionItem"
              >
              </el-option>
            </el-select>
      ...
      <template #footer>
        <div class="dialog-footer">
          <el-button @click="screenHandleClose">取 消</el-button>
          <el-button
            type="primary"
        ...
        if (valid) {
          ...
          for (
            ...
            if (item.condition === 4 || item.condition === 5) {
              ...
              this.$message.error(`第${index + 1}行筛选条件不完整，请确认`);
              fieldStatus = false;
          ...
          console.log("error submit!!", this.dynamicValidateForm.domains);
          return false;
        }
      });
    },
